package id.nns.narutomovieapp_local.data

import id.nns.narutomovieapp_local.R.drawable.naruto_movie_1
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_2
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_3
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_4
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_5
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_6
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_7
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_8
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_9
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_10
import id.nns.narutomovieapp_local.R.drawable.naruto_movie_11

object NarutoMovieRepository {
    fun getNarutoMovies(): List<NarutoMovieData> {
        return listOf(
            NarutoMovieData(
                id = 1,
                img = naruto_movie_1,
    ...
    fun getMovieById(movieId: Int): NarutoMovieData? {
        return getNarutoMovies().find { it.id == movieId }
    }
}
